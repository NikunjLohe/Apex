...
- Name: 02-role-permissions.spec.js >> Role-Based Permissions & Navigation >> Super Admin >> ROLE-002 | Super Admin cannot access /my-earnings directly (redirects to Unauthorized)
- Location: tests\specs\02-role-permissions.spec.js:29:5

# Error details

```
Error: Error reading storage state from tests/.auth/superadmin.json:
ENOENT: no such file or directory, open 'C:\Users\User\OneDrive\Desktop\Apex\tests\.auth\superadmin.json'
```
