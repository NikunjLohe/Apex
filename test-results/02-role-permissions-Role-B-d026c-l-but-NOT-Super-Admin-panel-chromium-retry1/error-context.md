...
- Name: 02-role-permissions.spec.js >> Role-Based Permissions & Navigation >> Admin (Rank 14+) >> ROLE-003 | Admin sees Admin panel but NOT Super Admin panel
- Location: tests\specs\02-role-permissions.spec.js:38:5
