...
- Name: 02-role-permissions.spec.js >> Role-Based Permissions & Navigation >> Branch Manager (Rank 10+) >> ROLE-005 | Manager sees Collect Payment and Reports, but NOT Admin panel
- Location: tests\specs\02-role-permissions.spec.js:58:5

# Error details

```
Error: Error reading storage state from tests/.auth/manager.json:
ENOENT: no such file or directory, open 'C:\Users\User\OneDrive\Desktop\Apex\tests\.auth\manager.json'
```
