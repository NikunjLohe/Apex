...
- Name: 02-role-permissions.spec.js >> Role-Based Permissions & Navigation >> Field Agent (Rank < 10) >> ROLE-007 | Agent cannot see Collect Payment or Admin pages
- Location: tests\specs\02-role-permissions.spec.js:77:5

# Error details

```
Error: Error reading storage state from tests/.auth/agent.json:
ENOENT: no such file or directory, open 'C:\Users\User\OneDrive\Desktop\Apex\tests\.auth\agent.json'
```
